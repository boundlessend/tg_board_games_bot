...
HELP_TEXT = (
    ...
    "В личке /bunker даёт код игры «Бункер» в режиме «отдельно»: без общей "
    "беседы, бот раздаёт карты каждому игроку в личку.\n\n"
    "Команды только для лички (в беседе они не работают):\n"
    "/joinbunker КОД - войти в такую партию по коду\n"
    ...
    "Инлайн-режим: набери @имя_бота в любом чате, чтобы получить "
    "случайные слова; текст после имени ищет слово по подстроке."
)
