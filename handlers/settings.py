...
SETTINGS_TEXT = (
    "Настройки.\n\n"
    "Авто-цикл личных словесных игр: при «вкл» после исчерпания слов круг "
    "начинается заново; при «выкл» нужно нажать «Новая игра». В командных "
    "играх беседы круг считается на партию, и настройка на них не влияет."
)

FORGET_ME_TEXT = (
    "Удалить все твои данные?\n\n"
    "Будут стёрты: история выданных слов, избранное, настройки, последнее "
    "слово и снапшоты партий, где ты участвуешь. Отменить это нельзя, "
    "история выдач начнётся с нуля."
)
