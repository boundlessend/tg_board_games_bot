...
Особые условия раздаются в личке вместе с картами и разыгрываются голосом. Состояние партии живёт в памяти процесса (теряется при перезапуске бота). Режим «отдельно» (через код-приглашение, без беседы) и развязка «История выживания» - в работе.
